...
/**
 * Reference consumer for this service's own {@code ipie-iam-service.events} topic -
 ...
 * turning "reliably delivered to the broker" into "queryable in {@code iam_audit_trail}"
 * regardless of which broker is actually configured. See {@link AuditEventCodec}'s Javadoc.
 */
@Component
