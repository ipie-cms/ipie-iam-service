 ...
 * PillarResolutionConsumer} as {@code AccountLinked}/{@code AccountUnlinkedPayload} arrive,
 ...
 */
@Service
public class PillarResolutionServiceImpl {

    private final PillarResolutionRepository repository;

    public PillarResolutionServiceImpl(PillarResolutionRepository repository) {
