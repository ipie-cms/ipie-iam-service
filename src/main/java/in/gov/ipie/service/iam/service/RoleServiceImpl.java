 ...
 * standards doc, 5.1) - {@link RealmRoleDirectory} calls here only sync that truth into
...
public class RoleServiceImpl implements RoleService {
    ...
    private final RealmRoleDirectory realmRoleDirectory;
    ...
    public RoleServiceImpl(
            ...
            RealmRoleDirectory realmRoleDirectory,
            CurrentUserProvider currentUserProvider) {
        this.roleRepository = roleRepository;
        this.userRoleRepository = userRoleRepository;
        this.permissionRepository = permissionRepository;
        this.realmRoleDirectory = realmRoleDirectory;
    ...
    public void deleteRole(UUID roleId) {
        ...
        realmRoleDirectory.deleteRealmRole(role.getName());
    }
    ...
    private void syncToKeycloak(Role role) {
        realmRoleDirectory.ensureRealmRole(role.getName(), role.getDescription());
        role.getPermissionNames().forEach(permission -> realmRoleDirectory.ensureRealmRole(permission, null));
        realmRoleDirectory.syncRealmRoleComposites(role.getName(), role.getPermissionNames());
    }
     ...
     * RealmRoleDirectory#assignRealmRoles}).
     */
    @Override
    @Transactional
    @Auditable(
    ...
    public void assignRole(AssignRoleCommand command) {
        ...
        realmRoleDirectory.assignRealmRoles(command.keycloakUserId(), List.of(role.getName()));
    }
    ...
    public void revokeRole(RevokeRoleCommand command) {
        ...
        realmRoleDirectory.removeRealmRoles(command.keycloakUserId(), List.of(role.getName()));
    }
