 ...
 * by {@link PillarResolutionConsumer}, not written to directly by any controller.
 */
@Entity
@Table(name = "pillar_resolution")
class PillarResolutionJpaEntity {
    ...
    protected PillarResolutionJpaEntity() {
        // required by JPA
    }

    PillarResolutionJpaEntity(
