 ...
 * plus the manual {@link AuditEvent} recording (see {@link PillarResolutionConsumer}'s
 * own Javadoc for why this is recorded manually rather than via {@code @Auditable}). Extracted out
 * of {@link PillarResolutionConsumer} (RabbitMQ) so {@link
 * KafkaPillarResolutionConsumer} can share the exact same logic rather than a second,
...
public class PillarResolutionEventHandler {
    ...
    private final PillarResolutionServiceImpl resolutionService;
    private final AuditRecorder auditRecorder;
    private final String serviceName;

    public PillarResolutionEventHandler(
            PillarResolutionServiceImpl resolutionService, AuditRecorder auditRecorder,
    ...
    public void handleAccountLinked(AccountLinkedPayload payload, String correlationId) {
        LOG.info(
    ...
    public void handleAccountUnlinked(AccountUnlinkedPayload payload, String correlationId) {
