 ...
 * {@link CredentialSetupTokenJpaRepository} or {@link CredentialSetupTokenJpaEntity}.
 *
...
class CredentialSetupTokenRepositoryImpl implements CredentialSetupTokenRepository {
    ...
    public CredentialSetupToken save(CredentialSetupToken token) {
        CredentialSetupTokenJpaEntity entity = jpaRepository.findById(token.tokenHash())
                .map(existing -> {
                ...
                .orElseGet(() -> new CredentialSetupTokenJpaEntity(
    ...
    private static CredentialSetupToken toDomain(CredentialSetupTokenJpaEntity entity) {
