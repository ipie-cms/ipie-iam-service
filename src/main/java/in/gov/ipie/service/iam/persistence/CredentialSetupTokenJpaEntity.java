...
class CredentialSetupTokenJpaEntity {
    ...
    protected CredentialSetupTokenJpaEntity() {
    }

    CredentialSetupTokenJpaEntity(String tokenHash, UUID keycloakUserId, Instant issuedAt, Instant expiresAt, Instant consumedAt) {
