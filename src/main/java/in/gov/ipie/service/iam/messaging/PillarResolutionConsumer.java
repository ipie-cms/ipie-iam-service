 ...
 * KafkaPillarResolutionConsumer} for the Kafka counterpart and {@code
...
class PillarResolutionConsumer {

    private final PillarResolutionEventHandler handler;
    private final ProcessedEventStore processedEventStore;

    PillarResolutionConsumer(PillarResolutionEventHandler handler, ProcessedEventStore processedEventStore) {
    ...
    void onAccountLinked(EventEnvelope<AccountLinkedPayload> event) {
    ...
    void onAccountUnlinked(EventEnvelope<AccountUnlinkedPayload> event) {
        IdempotentEventHandler.handle(
