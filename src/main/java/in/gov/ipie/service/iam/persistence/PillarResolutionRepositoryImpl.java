 ...
 * {@link PillarResolutionJpaRepository} or {@link PillarResolutionJpaEntity} - both stay
 ...
 * {@code PillarResolutionServiceImpl}, so these run inside the caller's transaction. That matters
...
class PillarResolutionRepositoryImpl implements PillarResolutionRepository {
    ...
    public void upsert(
            ...
            Instant syncedAt) {
        PillarResolutionJpaEntity entity = jpaRepository
                .findByPillarTypeAndExternalPillarId(pillarType, externalPillarId)
                .orElseGet(() -> new PillarResolutionJpaEntity(
    ...
    private static PillarResolution toDomain(PillarResolutionJpaEntity entity) {
