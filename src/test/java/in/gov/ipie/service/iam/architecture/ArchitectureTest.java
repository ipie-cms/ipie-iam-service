package in.gov.ipie.service.iam.architecture;
 ...
 *
 * <p>This service was missing this file entirely until now, despite the master standards doc
 * (Section 5) explicitly claiming every service scaffolded from {@code ipie-service-template} -
 * this one included - "carry their own copy of ArchitectureTest, still passing." Added to close
 * that gap rather than leave the claim false.
 */
@AnalyzeClasses(packages = "in.gov.ipie.service.iam")
class ArchitectureTest {

    private static final String BASE_PACKAGE = "in.gov.ipie.service.iam";
